          ...
          <div className="relative bg-[#1A1625]/50 backdrop-blur-xl rounded-3xl border border-white/10 p-8 md:p-12">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm text-gray-400 uppercase tracking-wider">Waitlist</div>
              ...
              <div className="text-center">
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #8B5CF6 0%, #A78BFA 50%, #CCFF00 100%)',
                    backgroundClip: 'text',
                ...
                <div className="text-gray-400 mt-2">Students Already Waiting</div>
              </div>
